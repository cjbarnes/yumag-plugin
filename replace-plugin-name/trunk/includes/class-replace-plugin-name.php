...
class Replace_Plugin_Name {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Replace_Plugin_Name_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * Uses the Replace_Plugin_Name_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Replace_Plugin_Name_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Replace_Plugin_Name_Public( $this->get_plugin_name(), $this->get_version() );
